...
\begin{figure}[h]
    ...
    {
     \caption{Caption located to the right and vertically aligned with the bottom of the figure. The text is justified on the left and the label of the figure is separated with a new line from the text.}
     \label{fig1}
    }
