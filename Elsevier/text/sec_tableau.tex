...
La création de tableaux dans Latex est probablement l'une des tâches les plus fastidieuses à faire, mais le résultat final en vaut la peine. Le \cref{tbl_mini_exemple} présente un exemple simple de tableau. Tout comme pour les figures, la position des tableaux est flottante dans le texte.
...
% S : Colonne spéciale du module siunitx qui permet l'alignement des chiffres sur la décimale. Il faut spécifier le format des données pour chaque colonne. 
